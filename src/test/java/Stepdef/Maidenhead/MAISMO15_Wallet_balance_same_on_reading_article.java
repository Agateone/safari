...
public class MAISMO15_Wallet_balance_same_on_reading_article {
...
WebDriver driver;
	...
	@Test(priority=83)
	public void i_register_successfully_on_Maidenhead_with_three_pound() throws InterruptedException {
	...
	@When("I read an article on Maidenhead")
	@Test(priority=84)
	public void i_read_an_article_on_Maidenhead() throws InterruptedException {
