...
Given I am a user of Axate and I am on the registration page through popbitch Wallet homepages "browser"
When I enter all the required details on step one and click on continue
And top up with a valid card in steptwo with one pound and click on continue
Then I get a funded axate wallet with one pound in it
...
#****
#POPSMO03
Scenario: Successful registration through login page popbitch
Given I am a user of Axate and I am on the login page through popbitch FUN "browser"
...
Scenario: Successful signup from popbitch FUN with one pounds "browser"
...
#POPSMO08
Scenario: Successful signup from popbitch FUN with three pounds
Given I am a user of Axate and I am on the registration page through popbitch FUN "browser"
When I enter all the required details on step one and click on continue
And I click on three pounds on regpage two
And enter valid card details and click on continue
...
#POPSMO09
Scenario: Successful signup from popbitch FUN with five pounds
Given I am a user of Axate and I am on the registration page through popbitch FUN "browser"
When I enter all the required details on step one and click on continue
...
Given I am a user of Axate and I am on the registration page through popbitch FUN "browser"
When I enter all the required details on step one and click on continue
And I skip the payment and navigating to a premium article on popbitch
