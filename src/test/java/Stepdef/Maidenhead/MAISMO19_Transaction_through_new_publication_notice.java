...
public class MAISMO19_Transaction_through_new_publication_notice {
WebDriver driver;
	@Given("I am a user of Axate and I am on the registration page through slough FUN {string}")
	@Test(priority=89)
	@Parameters("browser")
	public void i_am_a_user_of_Axate_and_I_am_on_the_registration_page_through_slough_FUN(String browser) throws InterruptedException {
		
			//firefox
			if(browser.equalsIgnoreCase("firefox")) {
				System.setProperty("webdriver.gecko.driver","C:/Users/Administrator/Desktop/geckodriver.exe");		
				driver = new FirefoxDriver();
				driver.get("http://staging.sloughexpress.co.uk/news/remember-when/136195/remember-when-when-the-town-s-five-secondary-schools-turned-comprehensive.html");
	...
	@When("I register successfully on slough with one pound")
	@Test(priority=90)
	public void i_register_successfully_on_slough_with_one_pound() throws InterruptedException {
	...
	@Test(priority=92)
	public void navigate_to_a_premium_article_on_maidenhead() {
	...
	public void wallet_balance_is_detucted_by_twentyfivep() throws InterruptedException {
		...
		w1.Click_On_popbitch_staging_agate_poster();
		String actual_current_balance=w1.current_balance();
		String expected_current_balance="2.60";
		Assert.assertEquals(actual_current_balance, expected_current_balance);
	}
...
//cant automate this step on bayliss, problem with right click 
