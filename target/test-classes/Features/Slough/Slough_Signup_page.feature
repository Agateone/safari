...
#****
#POPSMO01 
Scenario: Successful signup from slough FUN  
Given I am a user of Axate and I am on the registration page through slough FUN "browser"
...
#****
#POPSMO02 
Scenario: Successful signup from slough Wallet staging
Given I am a user of Axate and I am on the registration page through slough Wallet homepages "browser"
When I enter all the required details on step one and click on continue
And top up with a valid card in steptwo with one pound and click on continue
Then I get a funded axate wallet with one pound in it
And navigated to slough.com

#****
#POPSMO03
Scenario: Successful registration through login page slough
Given I am a user of Axate and I am on the login page through slough FUN "browser"
...
Scenario: Successful signup from slough FUN with one pounds "browser"
Given I am a user of Axate and I am on the registration page through slough FUN
When I enter all the required details on step one and click on continue
And I click on one pound on regpage two
...
#POPSMO08
Scenario: Successful signup from slough FUN with three pounds
Given I am a user of Axate and I am on the registration page through slough FUN "browser"
When I enter all the required details on step one and click on continue
And I click on three pounds on regpage two
And enter valid card details and click on continue
...
#POPSMO09
Scenario: Successful signup from slough FUN with five pounds
Given I am a user of Axate and I am on the registration page through slough FUN "browser"
When I enter all the required details on step one and click on continue
...
Given I am a user of Axate and I am on the registration page through slough FUN "browser"
When I enter all the required details on step one and click on continue
And I skip the payment and navigating to a premium article on slough
